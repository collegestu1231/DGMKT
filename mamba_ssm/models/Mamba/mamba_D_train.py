...
from mamba_D import MambaKTHeadModel
...
if __name__ == '__main__':
    ...
    parser.add_argument('--layer', type=int, default=4, help='The number of model layers') # 8
    parser.add_argument('--d_model', type=int, default=512, help='The dimension of the model') # 16
    ...
    log_file = os.path.join(
        'Test_result/mamba_D_l{}d{}_{}_test_result.txt'.format(params.layer, params.d_model, params.data_name))
