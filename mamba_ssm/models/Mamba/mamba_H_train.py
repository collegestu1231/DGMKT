...
from mamba_H import MambaKTHeadModel
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Script to train Mamba with hypergraph')
    ...
    parser.add_argument('--layer', type=int, default=4, help='The number of model layers')
    ...
    log_file = os.path.join(
        'Test_result/mamba_H_l{}d{}_{}_test_result.txt'.format(params.layer, params.d_model, params.data_name))
