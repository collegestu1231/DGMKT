...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Script to train DKVMN')
    ...
    # parser.add_argument('--layer', type=int, default=2, help='The number of model layers')
    parser.add_argument('--d_model', type=int, default=512, help='The dimension of the model')
    parser.add_argument('--size_m', type=int, default=50, help='')
    ...
    log_file = os.path.join(
        'dkvmn_d{}_{}_test_result.txt'.format( params.d_model, params.data_name))
    ...
    for dataset_set_index in range(5):
        ...
        # model
        net = DKVMN(params.n_skill,dim_s=params.d_model,size_m=params.size_m).to(device)
        net = net.to(device)
        ...
        save_model_file = os.path.join(
            './fold{}/{}/dim{}'.format(params.dataset_set_index, params.data_name,params.d_model))
