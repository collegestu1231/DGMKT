...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Script to train DKT with hypergraph')
    ...
    for dataset_set_index in range(5):
        ...
        G = adj.cuda()
        net = DKT(params.n_skill,emb_size=params.d_model, G=G).to(device)
        net = net.to(device)
