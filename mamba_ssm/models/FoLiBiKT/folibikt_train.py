...
if __name__ == '__main__':
    ...
    log_file = os.path.join(
        'Test_result/folibikt_d{}_{}_test_result.txt'.format(params.d_model, params.data_name))
    ...
    for dataset_set_index in range(5):
        ...
        # model
        net = folibiKT(n_question=params.n_skill,n_blocks=params.layer,num_attn_heads=params.num_heads,
                       d_model=params.d_model,dropout=0.05,kq_same=params.kq_same).to(device)
        net = net.to(device)
