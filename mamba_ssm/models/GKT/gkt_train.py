...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Script to train GKT')
    ...
    parser.add_argument('--d_model', type=int, default=16, help='The dimension of the model')
    ...
    log_file = os.path.join(
        'Test_result/gkt_d{}_{}_test_result.txt'.format(params.d_model, params.data_name))
    ...
    for dataset_set_index in range(5):
        ...
        # model
        graph = get_gkt_graph(params.n_skill)
        net = GKT(num_c=params.n_skill,graph=graph,dropout=0.05,emb_size=params.d_model,hidden_dim=params.d_model).to(device)
        net = net.to(device)
